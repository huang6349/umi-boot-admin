...
export const remoteDataSource = { type: 'umi:pageable', url: '/api/authority/pageable' };
...
export const actions = [
  {
    ...
    action: [{ type: 'umi:delete', url: '/api/authority/#{table.getSelectedRowKeys()}' }, 'refreshTable'],
  },
];
